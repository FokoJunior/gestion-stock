    ...
    <div class="row">
      <div class="col-md-12 col-xs-12">
        ...
        <?php if(in_array('createBrand', $user_permission)): ?>
          <button class="btn btn-primary" data-toggle="modal" data-target="#addBrandModal">Ajouter une Marque</button>
          <br /> <br />
        <?php endif; ?>

        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Gérer les Marques</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Ajouter une Marques</h4>
      </div>
      ...
      <form role="form" action="<?php echo base_url('brands/create') ?>" method="post" id="createBrandForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="brand_name">Nom de la marques</label>
            <input type="text" class="form-control" id="brand_name" name="brand_name" placeholder="Entrer le nom de la marque" autocomplete="off">
          </div>
          <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('brands/update') ?>" method="post" id="updateBrandForm">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <label for="edit_brand_name">Nom de la marque</label>
            <input type="text" class="form-control" id="edit_brand_name" name="edit_brand_name" placeholder="Entrer le nom de la marque" autocomplete="off">
          </div>
          <div class="form-group">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form role="form" action="<?php echo base_url('brands/remove') ?>" method="post" id="removeBrandForm">
        <div class="modal-body">
          <p>Voulez - vous vraiment l'enlever ??</p>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Fermer</button>
          <button type="submit" class="btn btn-primary">Enregister les changements</button>
