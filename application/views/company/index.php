        ...
        <div class="col-md-12 col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Gérer les informations de la Companies </h3>
            </div>
            <form role="form" action="<?php base_url('company/update') ?>" method="post">
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="company_name">Nom companies</label>
                ...
                <div class="form-group">
                  <label for="company_name">Message du footer</label>
                  <input type="text" class="form-control" id="company_footer" name="company_footer" placeholder="Enter company name" value="<?php echo $company_data['company_footer'] ?>" autocomplete="off">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="address" name="address" placeholder="Entrer l'addresse" value="<?php echo $company_data['address'] ?>" autocomplete="off">
                </div>
                <div class="form-group">
                  <label for="phone">Telephone</label>
                  <input type="text" class="form-control" id="phone" name="phone" placeholder="Entrer le No de Telephone" value="<?php echo $company_data['phone'] ?>" autocomplete="off">
                </div>
                <div class="form-group">
                  <label for="country">Pays</label>
                  <input type="text" class="form-control" id="country" name="country" placeholder="Entrer le nom du Pays" value="<?php echo $company_data['country'] ?>" autocomplete="off">
                </div>
                <div class="form-group">
